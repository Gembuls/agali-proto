  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div>
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            ...
            <a href="#" className="bg-zinc-700 p-4 rounded-2xl hover:bg-zinc-600">Lihat Proyek <i class="ri-arrow-down-fill ri-lg"></i></a>
          </div>
        </div>
        <img src={DataImage.HeroImage} alt="Hero Image" className="w-[400px] md:ml-auto rounded-2xl"/>
      </div>

      {/* TENTANG */}
      <div className="about mt-32 py-10">
        <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-600 rounded-lg">
        ...
        <div className="tools mt-32">
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {listTools.map((tool) => (
              ...
              rounded-md hover:bg-zinc-800 group" key={tool.id}>
              <img src={tool.gambar} alt="Image tols" className="w-14 bg-zinc-800 p-1 group-hover:bg-zinc-900"/>
              <div>
      ...
      <div className="proyek mt-32 py-10">
        ...
        <p className="text-base/loose text-center opacity-50">Berikut Ini Adalah Proyek Yang Telah Saya Buat</p>
