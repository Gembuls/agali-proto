  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
        ...
        <ul className="menu flex items-center gap-10 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0 -top-10 opacity-0 md:opacity-100 md:top-0">
            <li><a href="#" className="text-lg font-medium">Beranda</a></li>
            <li><a href="#" className="text-lg font-medium">Tentang</a></li>
            <li><a href="#" className="text-lg font-medium">Proyek</a></li>
            <li><a href="#" className="text-lg font-medium">Kontak</a></li>
        </ul>
    </div>
  )
};
